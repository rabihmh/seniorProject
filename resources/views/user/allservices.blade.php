            ...
            <div class="col-xl-3 col-lg-3 col-md-12 mb-3 mb-md-0">
                <div class="card">
                    ...
                    <div class="card-body pb-0">
                        ...
                        <button class="btn btn-primary-gradient mt-2 mb-2 pb-2" type="submit" id="filter">Filter
                        </button>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="pro-img-box">
                                        ...
                                        <img class="w-100"
                                             src="{{asset('images/projects/'.$service->project_photo)}}"
                                             alt="product-image">
...
@section('js')
    ...
    <script>
        $('#filter').on('click', function () {
            $value = $('#subCategory').find('option').not(':first').remove();
            let selectedCategory = $("#category option:selected").val();

            $.ajax({
                type: 'get',
                url: '{{route('services.all.search')}}',
