...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Admin</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Show Profile</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                                            ...
                                            <div class="card-body">
                                                <div class="pro-img-box">
                                                    ...
                                                    <img class="w-100"
                                                         ...
                                                         alt="product-image">
                                                    <a href="{{route('project.view',$project->id)}}" class="adtocart">
                                                        <i
