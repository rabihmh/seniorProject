                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <a style="margin: -4px 120px;" href="{{route('mark')}}">
                                <span
                                    class="badge badge-pill badge-warning mr-auto my-auto ">Mark All Read</span>
                                </a>
                            </div>
                            @php
                            ...
                            <p id="notifications_count"
                               class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">You
                                have {{ $user->unreadNotifications->count() }} unread
                                Notifications</p>
                        </div>
                        <div class="main-notification-list Notification-scroll">
                            <div id="unreadNotifications">
                                @foreach($user->unreadNotifications as $notification)
                                    @php
                                        $user_name=$notification->data['user'];
                                        $USER_DATA=\App\Models\User::where('name',$user_name)->with('profiles')->first()
                                    @endphp
                                    <a class="d-flex p-3 border-bottom"
                                       href="{{route('project.view',$notification->data['id'])}}">
                                        <div class="notifyimg bg-pink">
                                            <i class="la la-file-alt text-white"></i>
                                        </div>
                                        <div class="mr-3">
                                            <h5 class="notification-label mb-1">New service added
                                                by {{ $notification->data['user'] }} </h5>
